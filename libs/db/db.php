...
class JSONDatabase
{
    ...
    public function __construct($dbf = null, $dbd = null)
    {
        if ($dbf !== null) {
    ...
    public function init($dbf, $dbd = null)
    {
        if ($dbd !== null) {
            ...
            $dbd = rtrim($dbd, '/');
            $dbf = join(DIRECTORY_SEPARATOR, [$dbd, $dbf]); //Join or implode work here, join is shorter to type though
        }
    ...
    public function delete_table($table)
    {
        ...
        } elseif (file_exists($this->db."/tables/$table")) {
            //Open db.
    ...
    public function delete_row($table, $row)
    {
        ...
        if (!file_exists($this->db."/tables/$table")) {
            ...
            if (!file_exists($this->db."/tables/$table/$row")) {
                ...
                //Shit.
                return false; //No folder specified.
            } elseif (file_exists($this->db."/tables/$table/$row")) {
                //Open db.
